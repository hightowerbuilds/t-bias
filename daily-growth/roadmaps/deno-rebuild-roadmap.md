...
- [ ] Migration workflow (drizzle-kit Deno patch)
- [ ] Restore-on-launch: workspace layout + shell registry (active/detached/closed/crashed states)
- [ ] Atomic save on shutdown
