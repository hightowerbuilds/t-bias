...
var attrName = "[ " + spaces + "]+(?:use:<!--#-->|[^ \\f\\n\\r\\t\\/>\"'=]+)";
var tagName = "<([A-Za-z$#]+[A-Za-z0-9:_-]*)((?:";
var attrPartials = "(?:\\s*=\\s*(?:'[^']*?'|\"[^\"]*?\"|\\([^)]*?\\)|<[^>]*?>|" + almostEverything + "))?)";
var attrSeeker = new RegExp(tagName + attrName + attrPartials + "+)([  \\f\\n\\r\\t]*/?>)", "g");
var findAttributes = new RegExp("(" + attrName + "\\s*=\\s*)(<!--#-->|['\"(]([\\w\\s]*<!--#-->[\\w\\s]*)*['\")])", "gi");
var selfClosing = new RegExp(tagName + attrName + attrPartials + "*)([  \\f\\n\\r\\t]*/>)", "g");
var marker = "<!--#-->";
var reservedNameSpaces = new Set([
	"class",
	"on",
	"oncapture",
	"style",
